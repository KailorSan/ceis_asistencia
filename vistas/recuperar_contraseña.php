...
<div class="tarjeta-recuperacion">
    ...
    <?php if ($paso == 1): ?>
        ...
        <form action="../controladores/ControladorRecuperacion.php" method="POST" id="formularioBuscar" autocomplete="off">
            ...
            <input type="text" name="nombre_usuario" id="input_usuario" class="input-gris" 
                   placeholder="Usuario (Ej: JoseM12)" autocomplete="off">
    ...
    <!-- Paso 3: Asignación de Nueva Contraseña -->
    <?php elseif ($paso == 3): ?>
        ...
        <form action="../controladores/ControladorRecuperacion.php" method="POST" id="formularioClave" autocomplete="off">
            ...
            <div class="contenedor-clave">
                <input type="password" name="pass_1" id="nueva_clave_1" placeholder="Nueva Contraseña (Mínimo 6 caracteres)" autocomplete="off">
            ...
            <div class="contenedor-clave">
                <input type="password" name="pass_2" id="nueva_clave_2" placeholder="Repetir Contraseña" autocomplete="off">
...
<script>
    ...
    // Validación: Paso 1 (Búsqueda de Usuario)
    ...
    // Validación: Paso 2 (Respuestas de Seguridad)
    ...
    // Validación: Paso 3 (Cambio de Contraseña)
...
<!-- Notificaciones de error del backend -->
